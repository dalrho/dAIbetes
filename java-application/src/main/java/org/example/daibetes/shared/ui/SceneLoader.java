...
public class SceneLoader {
    ...
    public static Scene load(String folder, String fxml, String cssPath) {
        try {
            ...
            if (xmlLocation == null) throw new RuntimeException("ERROR: FXML not found: " + fullPath);
    ...
    public static void switchScene(Node sourceNode, String folder, String fxml, String title, String cssPath) {
        try {
            ...
            Scene scene = load(folder, fxml, cssPath);

            stage.setTitle(title);
            stage.setScene(scene);

            // --- KIOSK MODE SETTINGS ---
            stage.setFullScreenExitHint(""); // Removes the "Press ESC to exit" message
            stage.setFullScreen(true);        // Enables true full screen
    ...
    public static <T> T switchSceneWithController(Node sourceNode, String folder, String fxml, String title, String cssPath) {
        try {
            Stage stage = (Stage) sourceNode.getScene().getWindow();

            String fullPath = "/" + folder + "/" + fxml;
            FXMLLoader loader = new FXMLLoader(SceneLoader.class.getResource(fullPath));
            Parent root = loader.load();
            Scene scene = new Scene(root);
